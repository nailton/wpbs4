...
<div class="row">
  <div class="col mb-5">
    <div id="carousel-wpbs" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <a class="carousel-control-prev" href="#carousel-wpbs" role="button" data-slide="prev">
          <span class="carousel-control-prev-icon"></span>
          <span class="sr-only">Anterior</span>
        </a>
        <a class="carousel-control-next" href="#carousel-wpbs" role="button" data-slide="next">
    ...
    <div class="col-sm-12 col-md-4 mb-5">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="<?php the_permalink(); ?>" title="" class="btn btn-my-color-1">Leia mais</a>
        </div>
      </div>
    </div>
