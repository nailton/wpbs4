...
<div class="blog-comments">
  ...
  <h5 id="comments" class="mb-3"><?php comments_number(__('comentários'),__('1 comentário'),'%'.__(' comentários')); ?></h5>
  ...
  <?php $comments_arg = array(
    ...
    'class_submit'=>'btn btn-my-color-1',
    ...
    'comment_field'=>'<p>'.
    '<textarea id="comment" class="form-control" placeholder="Sua mensagagem..." name="comment" rows="3"
